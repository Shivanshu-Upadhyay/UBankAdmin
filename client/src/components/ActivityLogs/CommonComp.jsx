...
function CommonComp({ tableHeading,apiEndPoint,name }) {
  ...
  const ReadData = async () => {
    try {
     ...
     merchantSelect && formData.append("merchantName", merchantSelect);
      ...
      let result = await axios.post(`${baseUrl}/${apiEndPoint}`, formData, config);
      console.log(result);
  ...
  useEffect(() => {
    ReadData();
  }, [page, searchVal, limitVal,merchantSelect]);
    ...
    <>
      <Box component="main" className="allcol restBody">
        <div className="row align-items-center">
          ...
          <div className="col-3 mb-3"><FilterMerchant setMerchantSelect={setMerchantSelect} adminfilter={name==="Admin"?true:false}/></div>
        </div>
