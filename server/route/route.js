const subAdminController = require("../modules/login/Controller/subAdminController");
const midController = require("../modules/login/Controller/midController");
const loginController = require("../modules/login/Controller/loginController");
const bankCodeAkontoController = require("../modules/login/Controller/bankCodeAkontoController");
const bankCodeController = require("../modules/login/Controller/bankCodeController");
const contactController = require("../modules/login/Controller/contactController");
const siteSettingController = require("../modules/login/Controller/settingController/siteSettingController");
const currencyController = require("../modules/login/Controller/settingController/currencyController");
const exchangeController = require("../modules/login/Controller/settingController/exchangeController");
const allUpiController = require("../modules/login/Controller/SettingController/allUpiController");
const merchantAdminController = require("../modules/login/Controller/merchantAdminController");
const changePasswordController = require("../modules/login/Controller/changePassController");
// SATBIR CODE 
const paymentGatewayController = require("../modules/login/Controller/paymentController");
const chineseController = require("../modules/login/Controller/chineseController");
const transactionMTController = require("../modules/login/Controller/transactionMTController");
