...
class AddFund{
    async default(req,res){
        try {
            ...
            let sqlSearchCount = `select count (*) as Total from tbl_add_settlement_fund where creditacc LIKE '%${searchItem}%'`
            ...
            let sqlSearch = `select * from tbl_add_settlement_fund where creditacc LIKE '%${searchItem}%' ORDER BY created_on DESC limit ?,?`
